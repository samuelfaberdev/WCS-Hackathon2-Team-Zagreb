    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-[80%] flex flex-col">
        <Collapsible
          ...
          triggerClassName="toto bg-[#00ACB0] text-white flex w-full font-medium text-2xl mb-5 p-4 rounded-lg"
          triggerOpenedClassName="toto bg-[#00ACB0] text-white flex w-full font-medium text-2xl mb-5 p-4 rounded-lg"
        >
          <p className="mb-5">
        ...
        <Collapsible
          ...
          triggerClassName="bg-[#00ACB0] text-white flex w-full font-medium text-2xl mb-5 p-4 rounded-lg"
          triggerOpenedClassName="bg-[#00ACB0] text-white flex w-full font-medium text-2xl mb-5 p-4 rounded-lg"
        >
          <p className="mb-5">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non
            risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing
